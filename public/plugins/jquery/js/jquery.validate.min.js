...
(function(a) {
	a.extend(a.fn, {
		...
		rules: function(e, b) {
			...
			var f = a.validator.normalizeRules(a.extend({}, a.validator.classRules(g),a.validator.metadataRules(g), a.validator.attributeRules(g), a.validator.dataRules(g), a.validator.staticRules(g)), g);
			if (f.required) {
				var c = f.required;
				delete f.required;
				f = a.extend({
	...
	a.extend(a.validator, {
		...
		metadataRules: function(c) {
			if (!$.metadata) return {};
			var meta = $.data(c.form, 'validator').settings.meta;
			return meta ? $(c).metadata()[meta] : $(c).metadata();
		},
